/*================================================================================                               
*     Source: ../Lime/StrategyStudio/examples/strategies/SimplePairsStrategy/SimplePairsExample.cpp                                                        
...
#include "ModifiedPairsStrategy.h"
...
/*
     if (m_DebugOn) {
        ostringstream str;
        str <<"Top Quote " <<msg.instrument().symbol() << " price: "<< msg.bar();
